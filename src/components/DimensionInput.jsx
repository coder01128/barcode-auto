    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-sm border border-neutral-200 dark:border-neutral-700 p-4">
        ...
        <div className="flex flex-wrap gap-2">
          {PRESETS.map((p) => {
            const sel = p.w === width && p.h === height && p.gap === gap
            return (
              <button
                key={p.label}
                ...
                className={`px-3 py-1.5 text-sm border rounded-lg transition-all duration-200 active:scale-[0.95] ${
                  sel
                    ...
                    : 'border-accent/40 hover:bg-neutral-50 dark:hover:bg-neutral-700 dark:text-neutral-200'
                }`}
              >
                {p.label}
              </button>
      ...
      <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-sm border border-neutral-200 dark:border-neutral-700 p-4">
        <h3 className="font-semibold mb-4 dark:text-[#E8E8E8]">Enter your own label size if you don't see it above (mm)</h3>
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2 border rounded-lg text-sm dark:bg-neutral-700 dark:border-neutral-600 dark:text-neutral-200"
            />
            <p className="text-[13px] text-[#444] dark:text-neutral-400 mt-1 leading-tight">The gap between labels on your roll — measure from the bottom of one label to the top of the next. Usually 2–3mm. See the Preview below. A wrong value drifts progressively down the roll.</p>
          </div>
        </div>
      </div>
